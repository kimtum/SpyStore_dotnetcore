...
CREATE TABLE [Store].[Orders] (
    ...
    CONSTRAINT [FK_Orders_Costumers_CustomerId] FOREIGN KEY ([CustomerId]) REFERENCES [Store].[Costumers] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [Store].[ShoppingCartRecords] (
    ...
    CONSTRAINT [FK_ShoppingCartRecords_Costumers_CustomerId] FOREIGN KEY ([CustomerId]) REFERENCES [Store].[Costumers] ([Id]) ON DELETE CASCADE,
...
CREATE UNIQUE INDEX [IX_Customers] ON [Store].[Costumers] ([EmailAddress]);
...
VALUES (N'20210129145808_Initial', N'2.1.1-rtm-30846');

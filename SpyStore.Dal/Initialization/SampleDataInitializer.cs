        ...
        internal static void SeedData(StoreContext context)
        {
            try
            {
                ...
                if (!context.Customers.Any())
                {
                    ...
                    context.Customers
                        .AddRange(SampleData.GetAllCustomerRecords(new List<Product> { prod1, prod2, prod3, prod4 }));
